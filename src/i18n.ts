...
const ja: Translations = {
  ...
  petals: '花弁',           petalsHint: '万華鏡の折り数',
  spiral: 'ねじれ',     spiralHint: 'リングごとの捻り',
  ...
  morphSpeed: '変化のスピード',   morphSpeedHint: '形が変化していく速さ',

  chaos: 'カオス',          chaosHint: 'アトラクタの発散',
  flow: '流れ',             flowHint: '軌道の滑らかさ',
  orbit: '軌道',            orbitHint: '回転',
  organic: '生命感',        organicHint: '有機的な動き',
  ...
  cycle: '色の循環',        cycleHint: '時間とともに色が自動で漂う',
  cycleOff: 'オフ',

  mutateSlightly: '✦ 変奏',
  mutateHelp: '今の趣を保ったまま、すこし表情を変えます。',
  shuffleAll: '✦ 再生成',
...
const en: Translations = {
  ...
  mutateSlightly: '✦ Variation',
  mutateHelp: 'A small variation that keeps the current mood alive.',
  shuffleAll: '✦ Shuffle All',
  shuffleHelp: "Randomizes every unlocked section. There's no undo.",

  exportPng: 'Image',
  exportJson: 'Save Priset',
